...
# Tests to ensure that the C++ code wouldn't crash the system
...
test_that("rmse", {
  ...
  quickcheck::for_all(
    ...
    property = function(obs, sim, na_flag) {
      suppressWarnings(
        try(
          rmse_vec(truth = obs, estimate = sim, na_rm = na_flag),
          silent = TRUE
        )
      )
      expect_true(TRUE)
...
test_that("CV", {
  ...
  quickcheck::for_all(
    ...
    property = function(obs, na_flag) {
      suppressWarnings(
        try(
          cv_vec(truth = obs, na_rm = na_flag),
          silent = TRUE
        )
      )
      expect_true(TRUE)
...
test_that("GM", {
  ...
  quickcheck::for_all(
    ...
    property = function(obs, na_flag) {
      suppressWarnings(
        try(
          gm_vec(truth = obs, na_rm = na_flag),
          silent = TRUE
        )
      )
      expect_true(TRUE)
